...
const needKnows = [
  {
    ...
    msgs: [
      ...
      '脚本可以同时设置多个任务, 例如冒险神话8-5刷30次, 水装备本12层刷50次, 活动图V-3刷100次等等, 脚本会依次执行任务, 中间会自动穿插进行竞技场及商店购物, 脚本目前支持设置20个任务, 元素本及装备本可设置采用单次战斗, 减少失败时损失体力',
  ...
  },
  {
    ...
    msgs: [
      ...
      '双击脚本目录下的register.cmd, 弹出已成功提示框, 点确定后按要求输入注册码, 请确保无误(如果输入注册码回车后没有提示, 请关闭模拟器后重新执行register.cmd)'
    ]
  },
  {
    id: 2,
